...
const std::set<DisplayItem> AllDisplayItems
{
    ...
    , TDI_GPU_USAGE, TDI_CPU_TEMP, TDI_GPU_TEMP, TDI_HDD_TEMP, TDI_HDD1_TEMP, TDI_HDD2_TEMP, TDI_HDD3_TEMP, TDI_MAIN_BOARD_TEMP, TDI_HDD_USAGE, TDI_HDD1_USAGE, TDI_HDD2_USAGE, TDI_HDD3_USAGE,TDI_CPU_FREQ
#endif
    , TDI_TOTAL_SPEED
};
